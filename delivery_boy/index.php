...
if(isset($_GET['set_order_id'])){
   ...
   $getOrderById = getOrderById($set_order_id);
 ...
 $delivered_on=date('Y-m-d H:i:s');
   ...
   mysqli_query($con,"INSERT INTO `track_details`(`user_id`, `order_id`, `message`, `delay_msg`, `arrived_at`, `added_on`) VALUES ('$user_id', '$set_order_id', '4', 'Your Order is Delivered by ".$_SESSION['DELIVERY_BOY_USER']."', '$delivered_on', '$delivered_on')");
